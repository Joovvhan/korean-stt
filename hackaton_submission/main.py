...
def main():
    ...
    preloader_eval = Threading_Batched_Preloader(wav_path_list_eval, ground_truth_list_eval, korean_script_list_eval, batch_size, num_mels)
    preloader_train = Threading_Batched_Preloader(wav_path_list_train, ground_truth_list_train, korean_script_list_train, batch_size, num_mels)
