...
def bind_model(net, net_B, net_optimizer=None, net_B_optimizer=None, index2char=None):
...
def main():
    ...
    net_B = Seq2SeqNet(1024, jamo_tokens, char2index, device)  #########
